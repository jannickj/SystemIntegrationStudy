...
\input{"chapter/use_cases/use_case_buy_toll_tag"}
\subsubsection{Check in single ticket}
\input{"chapter/use_cases/use_case_check_in_single_ticket"}
\subsubsection{Check out single ticket}
\input{"chapter/use_cases/use_case_check_out_single_ticket"}
\subsubsection{Show report}
\input{"chapter/use_cases/use_case_show_report"}
\subsubsection{Check in toll tag}
\input{"chapter/use_cases/use_case_toll_tag_check_in"}
\subsubsection{Check out toll tag}
\input{"chapter/use_cases/use_case_toll_tag_check_out"}
