...
%\centering
%\includegraphics[width=0.8\textwidth]{img/composite_structure_diagram/cscd_toll_lane_express_in}
%\caption{The structure of the express check in lane}
%\label{fig:csd_tlei}
%\end{minipage}
%\begin{minipage}{0.4\textwidth}
%\centering
%\includegraphics[width=0.8\textwidth]{img/composite_structure_diagram/cscd_toll_lane_express_out}
